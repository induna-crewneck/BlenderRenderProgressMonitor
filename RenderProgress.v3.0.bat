...
title Blender Render Progress Monitor v3.0
REM === https://github.com/induna-crewneck

REM ==== ENTER VARIABLES HERE ===============================================================================
REM Output path specified in Blender:
set renderpath=S:\Digital\2022\20220402_Head\render\noisy\2e_full_v1_noisy_
...
set waittime=30
REM User input to variable:
REM set /P "variable=Enter variable:   "
REM echo %variable%
REM =========================================================================================================
